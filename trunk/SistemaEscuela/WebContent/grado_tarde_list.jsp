...
<br>  	
	...
	<div class="alert alert-info" role="alert">
		<button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
     	<strong><i class="glyphicon glyphicon-exclamation-sign"></i> Atención!</strong> No hay grados para el turno tarde. <a href="GradoEdit?do=alta" class="alert-link">Ingresar nuevo grado</a>
    </div>		
<%}else{%>
